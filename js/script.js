(function ($) {
    $(document).ready(function () {
        ...
        function send_form(type) {
            ...
            $.ajax({
                type: "GET",
                url: "https://script.google.com/macros/s/AKfycbw1WtEd82VbFsfndY24BFLeQSRMc26FtY0u5ZFBGhO-cbuoi5g/exec",
                data: {name: name, email: email, guest: guest, attending: attending},
                complete: function sent() {
                    $('#div_' + type).html("<div id='form_send_message'>RSVP Submitted! Thank you :)</div>", 1500);
                }
        ...
        /*CountDown*/
        $('.married_coundown').countdown({until: new Date("January 31, 2020 11:00:00")});
